...
* [Update discovery issues - firewall blocking SBE manifest](./Firewall-blocks-update-discovery.md)
* [SBE fails health check with content integrity issues](.HealthCheck-known-issues/SBE-HealthCheck-content-integrity-failure.md)
